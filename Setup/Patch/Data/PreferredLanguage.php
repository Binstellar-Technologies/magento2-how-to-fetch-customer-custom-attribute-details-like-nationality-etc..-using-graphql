...
/**
 * Creates a customer attribute for managing a customer's Preferred Language
 */
class PreferredLanguage implements DataPatchInterface
{
    /**
    ...
    public function apply()
    {
        ...
        try {
            ...
            $attribute = $this->customerSetup->getEavConfig()
                ->getAttribute(Customer::ENTITY, 'preferred_language');
