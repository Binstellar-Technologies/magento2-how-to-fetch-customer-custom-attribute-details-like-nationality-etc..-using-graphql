...
/**
 * Creates a customer attribute for managing a customer's Highest Education
 */
class HighestEducation implements DataPatchInterface
{
    /**
    ...
    public function apply()
    {
        ...
        try {
            ...
            $attribute = $this->customerSetup->getEavConfig()
                ->getAttribute(Customer::ENTITY, 'highest_education');
