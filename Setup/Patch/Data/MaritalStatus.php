...
/**
 * Creates a customer attribute for managing a customer's Marital Status
 */
class MaritalStatus implements DataPatchInterface
{
    /**
    ...
    public function apply()
    {
        ...
        try {
            ...
            $attribute = $this->customerSetup->getEavConfig()
                ->getAttribute(Customer::ENTITY, 'marital_status');
