...
class PreferredLanguage implements ResolverInterface
{
    ...
    public function resolve(Field $field, $context, ResolveInfo $info, array $value = null, array $args = null)
    {
        ...
        $preferred_language = $this->getCustomerPreferredLanguage($customerId);

        return $preferred_language;
    }

    private function getCustomerPreferredLanguage($customerId)
    {
        ...
        //Get segments text
        $preferred_language = $customer->getResource()
        ->getAttribute('preferred_language')
            ->getSource()
                ->getOptionText($customer->getData('preferred_language'));
        return $preferred_language;
    }
    }